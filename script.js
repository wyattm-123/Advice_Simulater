document.addEventListener('DOMContentLoaded', () => {
    ...
    function resetStory() {
        ...
        // Enable character interaction when story resets
        environment.setPlayingState(false);
    ...
    function playScene() {
        ...
        // Set environment playing state to prevent character interaction
        environment.setPlayingState(true);
    ...
    function playNextDialogue(scene) {
        if (currentDialogueIndex >= scene.dialogue.length) {
            ...
            // Allow character interaction when dialogue is finished
            environment.setPlayingState(false);
            return;
        }
